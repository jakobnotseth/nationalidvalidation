...
namespace NationalIdValidation
{
    ...
    public class NhsNumber
    {
        ...
        public NhsNumber(string nhsNumberString)
        {
            ...
            var numberResult = long.Parse(d1.ToString() + d2 + d3 + d4 + d5 + d6 + d7 + d8 + d9 + c1);
            if (numberResult >= 4000000000 && numberResult <= 4999999999 ||
                numberResult >= 6000000000 && numberResult <= 7088000019)
            ...
            else if (numberResult >= 0101010000 && numberResult <= 3112999999) Location = NhsNumberLocation.Scotland;
            IsValid = true;
        }
    }
}
